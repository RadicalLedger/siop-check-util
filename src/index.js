...
var DID_SIOP = require('did-siop');
var siop_rp = undefined;
var request;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, DID_SIOP.RP.getRP('localhost:4200/home', // RP's redirect_uri
                ...
                case 1:
                    siop_rp = _a.sent();
                    console.log('DID_SIOP.RP.getRP');
                    siop_rp.addSigningParams('CE438802C1F0B6F12BC6E686F372D7D495BC5AA634134B4A7EA4603CB25F0964', // Private key
                    ...
                    console.log('addSigningParams');
                    return [4 /*yield*/, siop_rp.generateRequest()];
                case 2:
                    request = _a.sent();
